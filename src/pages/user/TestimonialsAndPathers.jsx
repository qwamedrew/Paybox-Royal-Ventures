...
const testimonials = [
  {
    ...
    location: "Spain",
    quote:
      "Global Harvest has transformed our specialty foods sourcing process. Their reliable logistics and quality control ensure our customers always receive the authentic flavors they expect. We've doubled our import volume in just two years of partnership.",
    rating: 5,
  ...
  },
  {
    ...
    location: "Singapore",
    quote:
      "Working with Global Harvest has allowed us to introduce unique products from around the world to the Asian market. Their regulatory expertise saved us countless hours navigating import requirements across different countries.",
    rating: 5,
    image: "/api/placeholder/100/100",
  },
  {
    ...
    quote:
      "The market intelligence provided by Global Harvest gave us the confidence to expand into new territories. Their end-to-end service, from producer selection to final delivery, has been exceptional for our organic food line.",
    rating: 4,
    image: "/api/placeholder/100/100",
  },
  {
    ...
    location: "UAE",
    quote:
      "Temperature-controlled shipping is critical for our business, and Global Harvest has never let us down. Their attention to detail and proactive communication make them our preferred partner for all specialty food imports.",
    rating: 5,
    image: "/api/placeholder/100/100",
  },
];
...
const partners = [
  ...
  {
    id: 4,
    name: "Organic Producers Alliance",
    logo: "/api/placeholder/180/60",
  },
  {
    id: 5,
    name: "European Food Safety Association",
    logo: "/api/placeholder/180/60",
  },
  { id: 6, name: "Asian Import Consortium", logo: "/api/placeholder/180/60" },
  {
    id: 7,
    name: "American Specialty Grocers",
    logo: "/api/placeholder/180/60",
  },
  {
    id: 8,
    name: "International Food Quality Institute",
    logo: "/api/placeholder/180/60",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-8 mb-20">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            ...
            clients around the world, helping them succeed in the global food
            marketplace.
          </p>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-8 py-16">
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">
              Interested in becoming a partner? Let's discuss how we can grow
              together.
            </p>
            <Link to="/contactfd">
              <button
                className="inline-flex items-center px-6 py-3 rounded-lg font-medium text-white transition-all duration-300 transform hover:-translate-y-1 hover:opacity-90"
